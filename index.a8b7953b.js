class View {
    constructor({ addFilm, deleteFilmFromArray, doneFilmInArray }){
    ...
    _checkButton = ()=>{
        ...
        if (lengthString > INIT_SUM_SYMBOLS && lengthString <= MAX_SYMBOLS_IN_INPUT) this.addFilmButtonNode.disabled = false;
        else this.addFilmButtonNode.disabled = true;
    };
    _clearInput = ()=>{
